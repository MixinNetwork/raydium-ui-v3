        ...
        <VStack spacing={[2, 10]} maxW="4xl" mx="auto">
          ...
          >
            <Text fontSize={{ base: 'sm', md: 'md' }} lineHeight={1.625}>
              This website-hosted user interface (this “Interface”) is an open source frontend software portal to the Ocean protocol, a
              decentralized and community-driven collection of blockchain-enabled smart contracts and tools (the “Raydium Protocol”). This
              Interface and the Ocean Protocol are made available by the Ocean Holding Foundation, however all transactions conducted on
              the protocol are run by related permissionless smart contracts. As the Interface is open-sourced and the Ocean Protocol and
              its related smart contracts are accessible by any user, entity or third party, there are a number of third party web and
              mobile user-interfaces that allow for interaction with the Ocean Protocol.
            </Text>
            <Text fontSize={{ base: 'sm', md: 'md' }} lineHeight={1.625}>
              THIS INTERFACE AND THE RAYDIUM PROTOCOL ARE PROVIDED “AS IS”, AT YOUR OWN RISK, AND WITHOUT WARRANTIES OF ANY KIND. The
              Ocean Holding Foundation does not provide, own, or control the Ocean Protocol or any transactions conducted on the
              protocol or via related smart contracts. By using or accessing this Interface or the Ocean Protocol and related smart
              contracts, you agree that no developer or entity involved in creating, deploying or maintaining this Interface or the Ocean
              ...
              with other users of, this Interface or the Ocean Protocol, including any direct, indirect, incidental, special, exemplary,
              punitive or consequential damages, or loss of profits, digital assets, tokens, or anything else of value.
            </Text>
            <Text fontSize={{ base: 'sm', md: 'md' }} lineHeight={1.625}>
              The Ocean Protocol is not available to residents of Belarus, the Central African Republic, The Democratic Republic of Congo,
              ...
              which accessing or using the Ocean Protocol is prohibited (the “Prohibited Jurisdictions”).
            </Text>
            <Text fontSize={{ base: 'sm', md: 'md' }} lineHeight={1.625}>
              By using or accessing this Interface, the Ocean Protocol, or related smart contracts, you represent that you are not located
